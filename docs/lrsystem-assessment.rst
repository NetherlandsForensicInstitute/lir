...
Features of the `performance`_ of an LR system are discriminatory power and `consistency`_.
...
- in the ECE plot, the reference line is above the LRs line.


Badly calibrated data
---------------------

LR systems may misbehave in several ways, resulting in bad LLRs. Below are the results of four misbehaving sets of LLRs:

- LLRs biased towards H1
- LLRs biased towards H2
- overestimated LLRs
- underestimated LLRs
...
.. jupyter-execute::
    ...
    print('shift all LLR values towards H1')
...
- in the ECE plot, the LRs line is closer to the reference line and may even cross it or, if the LLRs are wildly biased,
  the LRs line is above the reference line;
- the Tippett plot is shifted to the left.


.. jupyter-execute::

    print('shift all LLR values towards H2')
...
.. jupyter-execute::
    ...
    print('increase the LLRs towards the extremes on both sides')
...
- in the ECE plot, the LRs line is slightly closer to the reference line, and may cross it near the extremes;
- the scale of the Tippett plot is increased.


.. jupyter-execute::

    print('reduce the LLRs towards neutrality')
...
- in the ECE plot, the LRs line is slightly closer to the reference line;
