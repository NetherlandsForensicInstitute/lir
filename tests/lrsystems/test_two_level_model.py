...
input_path = dirname / 'resources/two_level_model/input'
output_path = dirname / 'resources/two_level_model/R_output'
...
class TestTwoLevelModelNormalKDEPredict(unittest.TestCase):
    ...
    def test_ln_num(self):
        ...
        ln_num_P = self.two_level_model._predict_ln_num(
            data_tr[[0, 1], 1:], data_ref[:, 1:], covars_ref_inv, covars_trace_update_inv, updated_ref_mean_T
        )
    ...
    def test_log10_LR_from_formula_Bolck(self):
        ...
        log10_LR_P = self.two_level_model._predict_log10_LR_from_formula_Bolck(
            covars_trace_r, covars_trace_update_r, ln_num1_r, ln_den_left_r, ln_den_right_r
        )
