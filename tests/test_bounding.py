...
@pytest.mark.parametrize("lower_bound,upper_bound,llrs,expected_result", [
    (
            -1,
            1,
            np.arange(3),
...
def test_static_bounder(lower_bound: float, upper_bound: float, llrs: np.ndarray, expected_result: np.ndarray):
...
@pytest.mark.parametrize("lower_bound,upper_bound,llrs,labels", [
    (  # no labels argument
            -1,
            1,
            np.arange(3),
