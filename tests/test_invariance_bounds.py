...
class TestBounding(unittest.TestCase):
    ...
    def test_system01(self):
        ...
        bounds_bad = invariance_bounds.calculate_invariance_bounds(lrs, np.array([1, 1, 1, 0, 0]))
        bounds_good1 = invariance_bounds.calculate_invariance_bounds(lrs, np.array([0, 0, 1, 1, 1]))
        bounds_good2 = invariance_bounds.calculate_invariance_bounds(lrs, np.array([0, 0, 0, 1, 1]))
