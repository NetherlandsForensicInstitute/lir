...
class TestElub(unittest.TestCase):
    ...
    def test_system01(self):
        ...
        data_bad = LLRData(features=odds_to_logodds(lrs), labels=np.array([1, 1, 1, 0, 0]))
        data_good1 = LLRData(features=odds_to_logodds(lrs), labels=np.array([0, 0, 1, 1, 1]))
        data_good2 = LLRData(features=odds_to_logodds(lrs), labels=np.array([0, 0, 0, 1, 1]))
    ...
    def test_bias(self):
        ...
        data1 = LLRData(features=odds_to_logodds(lrs1), labels=y1)
        ...
        data2 = LLRData(features=odds_to_logodds(lrs2), labels=y2)
        ...
        data3 = LLRData(features=odds_to_logodds(lrs3), labels=y3)
