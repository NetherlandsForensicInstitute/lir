...
- Add comments or documentation where necessary. This should be done following the `numpy` docstring style, as configured in `pyproject.toml`. You can run `pdm run lint-docs` to validate the docstring style of your code.
